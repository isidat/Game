var Game = {
	...
	SheetEngine: {
		...
		CreateDummyObject: function() {
			var sheet1 = new sheetengine.Sheet({ x:0, y:0, z:Game.Config.BaseSheetSize/2 }, { alphaD:0, betaD:0, gammaD:0 }, { w:Game.Config.BaseSheetSize, h:Game.Config.BaseSheetSize });
			sheet1.context.fillStyle = "#F00";
			sheet1.context.fillRect(0, 0, Game.Config.BaseSheetSize, Game.Config.BaseSheetSize);
			sheet1.context.clearRect(10, 10, 30, 30);
